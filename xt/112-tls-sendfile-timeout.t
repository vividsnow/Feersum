...
run_client("tls-sendfile-not-truncated", sub {
    ...
    # A real IO::Socket, not a bare glob: start_SSL upgrades an IO::Socket
    # reliably, while a glob depends on the IO::Socket::SSL version (2.096
    # croaked "bad open mode" on CPAN Testers where 2.098 accepted it).
