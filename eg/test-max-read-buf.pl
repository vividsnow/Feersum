...
# are limited by MAX_BODY_LEN (64MB) instead.
use strict;
use warnings;
use Test::More;
use IO::Socket::INET;
...
# Content-Length bodies use Reader handle, limited by MAX_BODY_LEN (64MB)
###############################################################################
...
separate Reader handle and are limited by MAX_BODY_LEN (64MB) instead.
