    ...
    CODE:
{
    if (items > 1) {
        ...
        server->max_connection_reqs = (unsigned int)n;
    }
    ...
    PPCODE:
{
    ...
    if (sni_name) {
        ...
        if (!e) {
            ...
            Newx(e->hostname, name_len + 1, char);
            memcpy(e->hostname, lower, name_len + 1);
        }
