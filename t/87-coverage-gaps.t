...
#
# These used to assert "TE ignored, CL used".  That is the dangerous half of a
# TE.CL desync: a front end that honours Transfer-Encoding and a back end that
# honours Content-Length disagree on where the request ends - the smuggling
# primitive RFC 9112 6.1 warns about, and nginx's default proxy_http_version
# is 1.0.  Transfer-Encoding is undefined for HTTP/1.0, so it is now rejected.
#######################################################################
