...
# write_timeout.
#
# A later hole was independent of the deadline: nghttp2 was drained into
# tls_wbuf unconditionally, so nothing bounded the buffer at the default
# write_timeout of 0 and nghttp2's own flood detection never tripped.  A PING
# flood reached 2.1GB of RSS in 20s; h2_send_cb now refuses past
# FEER_H2_MAX_WBUF.
use warnings;
use strict;
