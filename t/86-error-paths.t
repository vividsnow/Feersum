...
#######################################################################
# env() was the only request accessor without a c->req guard.  Every sibling
# (method/uri/protocol/path/query/headers) croaks once the request has been
# freed; env() dereferenced the NULL and segfaulted.  return_from_io() frees
# the request while the Connection object is still perfectly alive in Perl.
#######################################################################
{
